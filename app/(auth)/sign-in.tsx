   ...
   <SafeAreaView className='bg-white/50 h-full px-5 py-7 flex flex-col items-center justify-center'>
         <View className='flex flex-col items-center'>
           ...
           <View className='w-full mt-3 flex items-center gap-y-1'>
             <Text className='text-3xl font-UrbanistBold text-primary'>Sign In</Text>
             <Text className='text-lg font-UrbanistMedium text-secondary/90'>Enter your Email and Password</Text>
             ...
             <View className='w-full px-5 flex flex-col gap-y-5 mt-5 items-center'>
               ...
               >
               <Text className='text-white font-UrbanistSemibold'>Sign In</Text>
             </TouchableOpacity>
             </View>
             ...
             <View className='flex flex-row items-center gap-1 mt-1'>
               <Text className='text-secondary font-UrbanistSemibold'>Don&apos;t have an account ?</Text>
               <Link href="/(auth)/sign-up" className='font-UrbanistBold text-blue-500'>Sign Up</Link>
             </View>
           </View>
         </View>
       </SafeAreaView>
